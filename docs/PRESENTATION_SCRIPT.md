# Refinery Outages — Presentation Script
...
## MAIN DECK — Gasoline & Diesel

**1 · Title**
This is the 2027 refinery-outage read — capacity offline by unit, where it sits, and what it tightens. The one
thing to hold onto up front: 2027's turnaround book is **heavier than last year**, and it lands on the **thinnest
inventory cushion in years**.

**2 · Total 2027 outages by unit**
Here are the four units we track. Crude is the big one — when a crude unit is down, the whole site is cut, gasoline
...
June into July** as turnarounds wound down for driving season. The Gulf drove the drop; the cat cracker and crude
led by unit. Five new outages, 48 back online. The point is the direction of travel, because that's how the balances
price.

**5 · H1 planned — 2025 / 2026 / 2027**
...
**February freeze** spike and the **September–October** turnaround overlap, summer quieter. That's the pattern to
carry into 2027 on top of the booked plan.

**9 · 2027 unplanned scenario**
This is the unplanned risk on top of the plan — a range, not a forecast. The middle path peaks around **2,900 kbd** of
unplanned in the worst month, the high case nearer **3,700**. Risk peaks in **February** and again in the **fall**.
I'd trade the high path as the supply-tightness stress case.

**10 · What it means for the market**
Putting it together: spring crude turnarounds cut the whole barrel right as we head into summer, on a thin cushion —
**gasoline −5%, distillate −10%, crude −7%** versus the five-year average. *[Gasoline:* the cat-cracker season plus the
summer-grade flip is the squeeze.*] [Diesel:* low distillate stocks plus crude cutting distillate yield is the squeeze,
into winter demand.*]* The tightness is coming **as much from low inventories as from the outage count.**

---

## CHEM-FEED DECK — Naphtha, Reformers & Octane
